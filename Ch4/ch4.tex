...
The paper is organised as follows.  We describe our data processing for the spectroscopic observations in Section~\ref{Herschel_obs4}, and discuss general observational results in Section~\ref{results}. In Sections~\ref{pdr_model4} and \ref{discussion} we compare our observations to theoretical models and discuss their implications, and summarize this work in Section~\ref{conclusions4}.
...
\tabletypesize{\small}
\tablecolumns{7}
\tablecaption{Basic details of the \emph{Herschel} spectroscopic observations of Centaurus~A\label{tbl:herschel_char4}}
\tablewidth{0pt}
\tablehead{
...
\begin{figure}[!htbp]
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_OI63_unconvolved_image_v1_cropped}}\\
...
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_OIII88_unconvolved_image_v1_cropped}}\\
\caption[]{\emph{continued}}
\end{figure}
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_NII122_unconvolved_image_v1_cropped}}\\
\caption[]{\emph{continued}}
\end{figure}
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_OI145_unconvolved_image_v1_cropped}}\\
\caption[]{\emph{continued}}
\end{figure}
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_CII157_unconvolved_image_v1_cropped}}\\
\caption[]{\emph{continued}}
\end{figure}
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_NII205_unconvolved_image_v1}}\\
\caption[]{\emph{continued}}
\end{figure}
...
\begin{figure}[!htbp]
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_colour_guide_cropped}}\\
...
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_CIIOI63_vs_CIIOI63onFtir_uncorrected_plot_radial_bins_v2}}\\
\caption[]{\emph{continued}}
\end{figure}
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_CIIOI63_vs_CIIOI63onFtir_corrected_plot_radial_bins_v2}}\\
\caption[]{\emph{continued}}
\end{figure}
\begin{figure}[!htbp]
\ContinuedFloat
\subfloat[]{\includegraphics[width=\columnwidth]{ch4/CenA_CIIOI145_vs_CIIOI63onFtir_corrected_plot_radial_bins_v2}}\\
\caption[]{\emph{continued}}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusions}\label{conclusions4}
...
{Parkin}, T.~J., {et~al.} 2013, \apj, in press
...
\bibitem[{{Wilson} {et~al.}(2013)}]{Wilson_2013}
{Wilson}, C.~D., {et~al.} 2013, \apjl, in press
